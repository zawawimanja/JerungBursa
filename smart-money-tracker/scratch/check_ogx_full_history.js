...
async function checkOgxFullHistory() {
    const ticker = '0395.KL';
    ...
    try {
        ...
        console.log(`\n🔍 MEMULAKAN SIMULASI SETUP GABUNGAN EMAS BAGI OGX (${prices.length} HARI TRADING)...`);
        ...
        if (triggers.length > 0) {
            console.log(`\n🎉 OGX PERNAH MASUK SETUP KITA PADA TARIKH BERIKUT:`);
            triggers.forEach(t => {
            ...
            console.log(`\n❌ OGX tidak pernah masuk Setup kita dalam 90 hari lepas.`);
        }
        
    } catch (e) {
        console.error(`❌ Gagal memproses OGX: ${e.message}`);
    }
}
