...
async function checkHkbFullHistory() {
    const ticker = '0359.KL';
    ...
    try {
        ...
        console.log(`\n🔍 MEMULAKAN SIMULASI SETUP GABUNGAN EMAS BAGI HKB (${prices.length} HARI TRADING)...`);
        ...
        if (triggers.length > 0) {
            console.log(`\n🎉 HKB PERNAH MASUK SETUP KITA PADA TARIKH BERIKUT:`);
            triggers.forEach(t => {
            ...
            console.log(`\n❌ HKB tidak pernah masuk Setup kita dalam 90 hari lepas.`);
        }
        
    } catch (e) {
        console.error(`❌ Gagal memproses HKB: ${e.message}`);
    }
}
